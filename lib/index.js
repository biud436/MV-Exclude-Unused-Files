...
class PluginConfiguration {
    ...
    readPluginFiles() {
        ...
        console.log(locale.getLocale("NUM_OF_PLUGINS", this._length));

        this._plugins.forEach((plugin, i) => {
            plugin.readComments((pluginName, noteParams) => {
                
                console.log(locale.getLocale("COMPLETED_TO_PARSE", pluginName));
                
                this._noteParams = this._noteParams.concat(noteParams);
                
                console.log(locale.getLocale("CONCAT_NOTE_PARAMS", noteParams));
                
                this._pendingDone[i] = true;

                if(this.isReady()) {
                    console.log(locale.getLocale("COMPLETED_PARSING_ALL_PLUGINS"));
