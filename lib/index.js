...
let Helper = {
    ...
    getOptions() {
        ...
        if(processArgs.length < 1) {
            new Error("Cannot find sourceDir and targetDir. the number of arguments is zero.");
        }

        this.extractSourceDir();
        this.extractTargetDir();
